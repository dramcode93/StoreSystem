...
export default function Card({ id, icon, name, adminName, showMore,rooms, click }) {
    const language =useI18nContext();
    return (
        <div onClick={click} className={`cursor-pointer bg-gray-700 bg-opacity-25 rounded-md absolute top-32 -z-3 w-1/4 ${language === "ar" ? "left-10" : "right-10"}`}>
            <div

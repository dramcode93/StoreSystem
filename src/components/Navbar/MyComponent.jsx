...
const MyComponent = () => {
  ...
  return (
    <div className="z-50 fixed w-100 shadow shadow-gray-200 dark:shadow-gray-900  dark:bg-gray-900 p-6" dir={language === "ar" ? "rtl" : "ltr"} style={{ backgroundColor: 'var(--back)' }}>

          ...
          <>
            {bills.map((bill) => (
              <div key={bill._id} className={styles.billsTable}>
                <div className="flex">
                  <div>
                    <p>Bill Code : {bill._id.slice(-4)}</p>
                    <p>Client Name : {bill.customerName}</p>
                    <p>Phone : {bill.phone}</p>
                    <p>customer Address : {bill?.customerAddress}</p>
                  </div>
                  <div>
                    <p>Name Seller: {bill?.user.name}</p>
                    <p>
                      Bill Date :{" "}
                      {bill?.createdAt &&
                        new Date(bill.createdAt).toLocaleDateString("ar", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                          hour: "numeric",
                    ...
                    <p>
                      update Date :{" "}
                      {bill?.updatedAt &&
                        new Date(bill.updatedAt).toLocaleDateString("ar", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                          hour: "numeric",
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colSpan="2">Total : {bill.totalAmount}</td>
                      <td>Paid : {bill.paidAmount}</td>
                      <td>Remaining : {bill.remainingAmount}</td>
                    </tr>
                  </tbody>
                </table>

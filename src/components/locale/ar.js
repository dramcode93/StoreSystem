const ar = {
  ...
  Home: {
    ...
    LogOut: "تسجيل الخروج",
    Mode: "تغيير الوضع",
    shopTypes: "أنواع المحلات",
    IdontHaveAccount: "ليس لدي حساب. إنشاء حساب؟",
    Email: "البريد الإلكتروني",
    SendResetCode: "إرسال رمز التفعيل",
    Sending: "جاري الإرسال...",
    Step2: "الخطوة 2: التحقق من الهوية",
    Wesentverification: "لقد أرسلنا رمز التحقق إلى بريدك الإلكتروني. يرجى إدخال الرمز بالأسفل.",
    Enterverificationcode: "أدخل رمز التحقق",
    Loading: "جاري التحميل...",
    ResetPassword: "إعادة تعيين كلمة المرور",
    Step3: "الخطوة 3: إعادة تعيين كلمة المرور",

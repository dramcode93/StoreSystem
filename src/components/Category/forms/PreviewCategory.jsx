...
export default function PreviewCategory({ closeModal, assistantData }) {
  ...
  const birthDate = assistantData.birthDate
    ? new Date(assistantData.birthDate)
    : null;
      ...
      >
        ...
        >
          <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <FormPreview t={t} details={detailsData} />
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                >
                  <span className="font-bold text-base">
                    {t("previewForm.assistantsDetails.edit")}
                  </span>
                </button>
              </div>
              <button
              ...
              >
                ...
                <span className="font-bold text-base">
                  {t("previewForm.assistantsDetails.delete")}{" "}
                </span>
              </button>
            </div>
          </div>
